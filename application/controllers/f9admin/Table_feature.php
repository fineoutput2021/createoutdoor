<?php
    if ( ! defined('BASEPATH')) exit('No direct script access allowed');
       ...
       class Table_feature extends CI_finecontrol{
       function __construct()
         ...
         public function view_table_feature(){
            ...
            if(!empty($this->session->userdata('admin_data'))){
              ...
              // exit;
               ...
               $data['table_feature_data']= $this->db->get();

              $this->load->view('admin/common/header_view',$data);
              $this->load->view('admin/table_feature/view_table_feature');
             ...
             redirect("login/admin_login","refresh");
              ...
              public function add_table_feature(){

                 if(!empty($this->session->userdata('admin_data'))){

                   $this->load->view('admin/common/header_view');
                   $this->load->view('admin/table_feature/add_table_feature');
                   $this->load->view('admin/common/footer_view');
               ...
               public function update_table_feature($idd){
                   ...
                   if(!empty($this->session->userdata('admin_data'))){
                     ...
                     $data['id']=$idd;
                            ...
                            $this->db->from('tbl_table_feature');
                            $this->db->where('id',$id);
                            $data['table_feature_data']= $this->db->get()->row();


                     $this->load->view('admin/common/header_view',$data);
                     $this->load->view('admin/table_feature/update_table_feature');
                     $this->load->view('admin/common/footer_view');
             ...
             public function add_table_feature_data($t,$iw="")
 ...
 $this->session->set_flashdata('emessage','Please insert some data, No data available');
      redirect($_SERVER['HTTP_REFERER']);
       ...
       redirect("login/admin_login","refresh");
               ...
               public function updatetable_featureStatus($idd,$t){
        ...
        $this->session->set_flashdata('emessage','Sorry error occured');
          redirect($_SERVER['HTTP_REFERER']);
               ...
               public function delete_table_feature($idd){
 ...
 $zapak=$this->db->delete('tbl_table_feature', array('id' => $id));
 if($zapak!=0){
        // $path = FCPATH .$img;
        //   unlink($path);
