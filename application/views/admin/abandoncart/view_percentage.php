                                ...
                                <div class="col-lg-12">
                                  ...
                                  <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                      <div class="col-lg-10">
                                        <form action="<?php echo base_url() ?>dcadmin/Abandoncart/add_percentage_data/<?php echo base64_encode(2); ?>/<?=base64_encode($percentage_data->id)?>" method="POST" id="slide_frm" enctype="multipart/form-data">
