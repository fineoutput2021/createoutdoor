        ...
        <h3 class="panel-title"><i class="fa fa-money fa-fw"></i>View topbar</h3>
        </div>
        <div class="panel panel-default">
 	 ...
 	 <th>link</th>
        ...
        <tbody>
        <?php $i=1; foreach($topbar_data->result() as $data) { ?>
        <tr>
        <td><?php echo $i ?> </td>
 	 ...
 	 <td><?php echo $data->link ?></td>
        ...
        <li><a href="<?php echo base_url() ?>dcadmin/topbar/updatetopbarStatus/<?php echo
        base64_encode($data->id) ?>/inactive">Inactive</a></li>
        <?php } else { ?>
        <li><a href="<?php echo base_url() ?>dcadmin/topbar/updatetopbarStatus/<?php echo
        base64_encode($data->id) ?>/active">Active</a></li>
        <?php } ?>
        <li><a href="<?php echo base_url() ?>dcadmin/topbar/update_topbar/<?php echo
        ...
        <a href="<?php echo base_url() ?>dcadmin/topbar/delete_topbar/<?php echo
