          ...
          <td> <input type="file" name="fileToUpload1"  class="form-control" placeholder=""  value="" />  </td>
          </tr>
          <tr>
          <tr>
          <td> <strong>productimage2</strong>  <span style="color:red;">*</span></strong> </td>
          <td> <input type="file" name="fileToUpload2"  class="form-control" placeholder=""  value="" />  </td>
          </tr>
          <tr>
          <tr>
          <td> <strong>productimage3</strong>  <span style="color:red;">*</span></strong> </td>
          <td> <input type="file" name="fileToUpload3"  class="form-control" placeholder=""  value="" />  </td>
          </tr>
          <tr>
          <tr>
          <td> <strong>productimage4</strong>  <span style="color:red;">*</span></strong> </td>
          <td> <input type="file" name="fileToUpload4"  class="form-control" placeholder=""  value="" />  </td>
          </tr>
          <tr>
          ...
          <td> <input type="text" name="productdescription"  class="form-control" placeholder=""  value="" />  </td>
          </tr>
          <tr>
          <td> <strong>colours</strong>  <span style="color:red;">*</span></strong> </td>
          <td> <input type="color" name="colours"  class="form-control" placeholder=""  value="" />  </td>
          </tr>
          <tr>
          <td> <strong>inventory</strong>  <span style="color:red;">*</span></strong> </td>
          <td> <input type="text" name="inventory"  class="form-control" placeholder=""  value="" />  </td>
          </tr>
