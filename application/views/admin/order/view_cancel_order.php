<div class="content-wrapper">
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="<?php echo base_url() ?>dcadmin/Neworder/view_cancel_orders"><i class="icon-undo"></i> View Cancel Order </a></li>
      ...
      <div class="col-lg-12">
        ...
        <div class="panel panel-default">
          <div class="panel-heading">
            <h3 class="panel-title"><i class="fa fa-money fa-fw"></i>View Cancelled Order</h3>
          </div>
          <div class="panel panel-default">
