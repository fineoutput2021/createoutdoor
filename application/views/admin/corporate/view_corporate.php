<div class="content-wrapper">
  ...
  <section class="content">
    <div class="row">
      <div class="col-lg-12">
        <!-- <a class="btn custom_btn" href="<?php echo base_url() ?>dcadmin/corporate/add_corporate" role="button" style="margin-bottom:12px;"> Add Corporate</a> -->
                ...
                <table class="table table-bordered table-hover table-striped" id="userTable">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <?php if($data->image1!=""){  ?>
                        <img id="slide_img_path" height=50 width=100 src="<?php echo base_url()."assets/uploads/customproduct/".$data->image1 ?>">
                        <?php }else {  ?>
                      ...
                      <td>
                        <?php if($data->image2!=""){  ?>
                        <img id="slide_img_path" height=50 width=100 src="<?php echo base_url()."assets/uploads/customproduct/".$data->image2 ?>">
                        <?php }else {  ?>
                        Sorry No image Found
                        <?php } ?>
                      </td>
                      <td>
                        <?php if($data->image3!=""){  ?>
                        <img id="slide_img_path" height=50 width=100 src="<?php echo base_url()."assets/uploads/customproduct/".$data->image3 ?>">
                        <?php }else {  ?>
                        Sorry No image Found
                        <?php } ?>
                      </td>
                      <td>
                        <?php if($data->image4!=""){  ?>
                        <img id="slide_img_path" height=50 width=100 src="<?php echo base_url()."assets/uploads/customproduct/".$data->image4 ?>">
                        <?php }else {  ?>
                        Sorry No image Found
                        <?php } ?>
                      </td>
