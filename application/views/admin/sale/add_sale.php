              ...
              <div class="col-lg-12">
                               ...
                               <div class="panel panel-default">
                                   <div class="panel-heading">
                                       <h3 class="panel-title"><i class="fa fa-money fa-fw"></i> Add New Two Images</h3>
                                   </div>
                                   ...
                                   <div class="panel-body">
                                       <div class="col-lg-10">
                                          <form action=" <?php echo base_url()  ?>dcadmin/sale/add_sale_data/<? echo base64_encode(1);  ?>" method="POST" id="slide_frm" enctype="multipart/form-data">
...
<td> <input type="url" name="link"  class="form-control" placeholder="" required value="" />  </td>
</tr>
  <tr>
...
<td> <input type="file" name="fileToUpload2"  class="form-control" placeholder="" required value="" />  </td>
</tr>
