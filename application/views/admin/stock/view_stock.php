        ...
        <h3 class="panel-title"><i class="fa fa-money fa-fw"></i>View stock</h3>
        </div>
        <div class="panel panel-default">
	 ...
	 <td><?php echo $data->title ?></td>
 	 <td><?php echo $data->description ?></td>
        ...
        <li><a href="<?php echo base_url() ?>dcadmin/stock/updatestockStatus/<?php echo
        base64_encode($data->id) ?>/inactive">Inactive</a></li>
        <?php } else { ?>
        <li><a href="<?php echo base_url() ?>dcadmin/stock/updatestockStatus/<?php echo
        base64_encode($data->id) ?>/active">Active</a></li>
        <?php } ?>
        <li><a href="<?php echo base_url() ?>dcadmin/stock/update_stock/<?php echo
        ...
        <a href="<?php echo base_url() ?>dcadmin/stock/delete_stock/<?php echo
