      ...
      <div class="col-lg-12">
        ...
        <div class="panel panel-default">
          <div class="panel-heading">
            <h3 class="panel-title"><i class="fa fa-money fa-fw"></i> Update Sliderpanel </h3>
          </div>
          ...
          <div class="panel-body">
            <div class="col-lg-10">
              <form action=" <?php echo base_url(); ?>dcadmin/sliderpanel/add_sliderpanel_data/<?php echo base64_encode(2); ?>/<?=$id;?>" method="POST" id="slide_frm" enctype="multipart/form-data">
                <div class="table-responsive">
                  <table class="table table-hover">
                    <tr>
                      <td> <strong>name</strong> <span style="color:red;">*</span></strong> </td>
                      <td> <input type="text" name="name" class="form-control" placeholder="" value="<?=$sliderpanel_data->name;?>" /> </td>
                    </tr>
                    <tr>
  ...
  ?>">
                    ...
                    <tr>
                      ...
                      <td> <input type="file" name="image2" class="form-control" placeholder="" />
                        <?php if ($sliderpanel_data->image2!="") { ?>
                        <img id="slide_img_path" height=50 width=100 src="<?php echo base_url().$sliderpanel_data->image2
  ?>">
                        <?php } else { ?>
                        Sorry No File Found
                        <?php } ?>
