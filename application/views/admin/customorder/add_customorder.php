                          <div class="content-wrapper">
                                  <section class="content-header">
                                    ...
                                    <ol class="breadcrumb">
                                      ...
                                      <li><a href="<?php echo base_url() ?>dcadmin/customorder/view_customorder"><i class="icon-undo"></i> View Custom Order </a></li>
                                 ...
                                 <div class="col-lg-12">
                                                  ...
                                                  <div class="panel panel-default">
                                                      ...
                                                      <div class="panel-body">
                                                          <div class="col-lg-10">
                                                             <form action="<?php echo base_url() ?>dcadmin/customorder/add_data_customorder/<? echo base64_encode(1); ?>" method="POST" id="slide_frm" enctype="multipart/form-data">
                                                          <div class="table-responsive">
                                                              <table class="table table-hover">
                                                                ...
                                                                <tr>
                                                                                          ...
                                                                                          <td>
                                          													<input type="text" name="firstname"  class="form-control" placeholder="" required value="" />
                                          	                                            </td>
                                              										</tr>
                                          											<tr>
                                                                                          <td> <strong>Last Name</strong>  <span style="color:red;">*</span></strong> </td>
                                                                                          <td>
                                          													<input type="text" name="lastname"  class="form-control" placeholder="" required value="" />
                                          	                                            </td>
                                              										</tr>
                                          											<tr>
                                                                                          <td> <strong>Business Name</strong>  <span style="color:red;">*</span></strong> </td>
                                                                                          <td>
                                          													<input type="text" name="businessname"  class="form-control" placeholder="" required value="" />
                                          	                                            </td>
                                              										</tr>
                                          											<tr>
