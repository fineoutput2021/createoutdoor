      ...
      <div class="col-lg-12">
            ...
            <div class="panel-body">
              <div class="box-body table-responsive no-padding">
                <table class="table table-bordered table-hover table-striped" id="userTable">
                  ...
                  <tbody>
                    <?php $i=1; foreach($gallery2_data->result() as $data) { ?>
                    <tr>
                      <td><?php echo $i ?> </td>
                        ...
                        <div class="btn-group" id="btns<?php echo $i ?>">
                          <div class="btn-group">
                            ...
                            <ul class="dropdown-menu" role="menu">
                              ...
                              <li><a href="<?php echo base_url() ?>dcadmin/gallery2/updategallery2Status/<?php echo
        base64_encode($data->id) ?>/inactive">Inactive</a></li>
                              <?php } else { ?>
                              <li><a href="<?php echo base_url() ?>dcadmin/gallery2/updategallery2Status/<?php echo
        base64_encode($data->id) ?>/active">Active</a></li>
                              <?php } ?>
                              <li><a href="<?php echo base_url() ?>dcadmin/gallery2/update_gallery2/<?php echo
        base64_encode($data->id) ?>">Edit</a></li>
                        ...
                        <div style="display:none" id="cnfbox<?php echo $i ?>">
                          ...
                          <a href="<?php echo base_url() ?>dcadmin/gallery2/delete_gallery2/<?php echo
